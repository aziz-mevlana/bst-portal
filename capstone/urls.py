...
urlpatterns = [
    ...
    path('advisor/students/claim-selected/', academic_views.advisor_claim_bulk, name='advisor_claim_bulk'),
    ...
    path('advisor/projects/<int:project_id>/purge/', academic_views.advisor_project_purge, name='advisor_project_purge'),
