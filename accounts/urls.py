...
urlpatterns = [
    ...
    path('portfolio/certificates/reviews/', views.portfolio_certificate_reviews, name='portfolio_certificate_reviews'),
    path('portfolio/certificates/<int:certificate_id>/review/', views.portfolio_certificate_review, name='portfolio_certificate_review'),
    path('portfolio/certificates/<int:certificate_id>/edit/', views.portfolio_certificate_edit, name='portfolio_certificate_edit'),
    ...
    path('privacy/delete-account/', views.account_delete, name='account_delete'),
]
